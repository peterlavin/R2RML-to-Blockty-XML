...
public class ProcessLogicalTable {
	...
	public Document processLogicalTable(TriplesMap tmap, Element tripmapBlockElem) {
		...
		// if(tripmapBlockElem.hasAttribute(CONST.TYPE) &&
		// (tripmapBlockElem.getAttribute(CONST.TYPE).equalsIgnoreCase(CONST.TRIPLESMAP))){
		...
		// else {
		//
		// System.out.println("Something has gone wrong, first child of
		// triplesmap element is not a block");
		// System.exit(1);
		//
		// }
